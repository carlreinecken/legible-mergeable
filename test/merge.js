...
describe('merge objects', function () {
  ...
  it('two with new and deleted properties', function () {
    const docA = { age: 13, [MODS_KEY]: { pet: '2020-09-01' } }
  ...
  it('nested properties, list as top level', function () {
    const docA = {
      1: { name: 'gustav', age: 22, [MODS_KEY]: {} },
      2: { name: 'bob', age: 44, [MODS_KEY]: { age: '2021-09-03' } },
      [MODS_KEY]: {}
    }

    const docB = {
      2: { name: 'hi bob', age: 12, [MODS_KEY]: { name: '2021-09-02' } },
      [MODS_KEY]: { 1: '2021-09-01' }
    }

    const expected = {
      2: { name: 'hi bob', age: 44, [MODS_KEY]: { name: '2021-09-02', age: '2021-09-03' } },
      [MODS_KEY]: { 1: '2021-09-01' }
    }
